...
const unsigned int SET_TIME = 500;
...
const float dK = 0.25;	//0.9
const float gain = 0.5;
const float intTime= 5;  // 0 - 1
const float time_interval = 0.002;
...
const int SPEED_SHIFT = 3;
const int FADER_SHIFT_PID = 3;
const int READ_SHIFT = 4;
const int GOAL_SHIFT = 6;
