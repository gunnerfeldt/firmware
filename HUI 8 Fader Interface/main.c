	...
	if(cnt>0xfffe)
		{
				...
				lobyte=(fader_out&0x000E)<<4; // 0000 0000 0000 0xx0
				hibyte=(fader_out&0x03FF)>>3; // 0000 00xx xxxx x000

/*
		        midiOutBuffer[8] = 0x00;  //pad
				midiOutBufferLen=7;
				midiPacketCntr=0;
*/

        midiData.CableNumber 		= 0;
		midiData.CodeIndexNumber   	= MIDI_CIN_CONTROL_CHANGE; //0xB
		midiData.DATA_0 			= 0xb0;
        midiData.DATA_1 			= 0x07;       			// 0xXY Y=ch no
        midiData.DATA_2 			= hibyte;
		...
		midiData.CodeIndexNumber   	= MIDI_CIN_CONTROL_CHANGE; 	//0xB
		midiData.DATA_0 			= 0xb0;
        midiData.DATA_1 			= 0x27;            			// 0xXY Y=ch no  
        midiData.DATA_2 			= lobyte;					// 0xXY X=0XX0 Hibyte  
    ...
    if(!USBHandleBusy(USBRxHandle))
    {
        ...
        midiData.word = 0;   //must set all unused values to 0 so go ahead
